...
(function () {
  ...
  var DICT = {
    'zh-CN': {
      ...
      'empty.kb': '🪐 知识宇宙中还没有星光，选中网页文字即可收集。',
      'empty.kb.detail': '知识库「{name}」中还没有星光',
      ...
      'wormhole.suggestions.empty': '🪐 暂无AI建议连接<br><span style="font-size:10px;">分析PDF后将自动推荐关联</span>',
      ...
      'detail.galaxy': '所属星系: {name}',
      'detail.wanderer': '流浪恒星',
      'detail.connections': '🔗 关联恒星: {count} 颗（其中 {ai} 个虫洞连接）',
      'detail.index': '📇 索引: #{idx}',
      'tooltip.connections': '关联 {count} 个节点',
      'stats.loading': '加载中...',
      'stats.empty': '知识宇宙空旷无垠',
      'stats.count': '{n} 节点 · {g} 星系 · {e} 连线',
      'breadcrumb.all': '全部',
      'breadcrumb.galaxy': '{name}',
      'breadcrumb.star': '{label}',
      'canvas.empty': '知识宇宙中还没有节点，去收集一些知识点吧',
      'zoom.in': '放大',
      'zoom.out': '缩小',
      'zoom.reset': '重置视图',
    ...
    en: {
      // ---- 通用 ----
      'app.name': 'KnowLink Knowledge Galaxy',
      ...
      'fullscreen': 'Open fullscreen galaxy in new tab',
      'empty.kb': '🪐 No stars in the knowledge universe yet. Select text on a webpage to collect.',
      'empty.kb.detail': 'No stars in knowledge base "{name}" yet',
      ...
      'view.pdf.hint': 'Click a knowledge point in the galaxy sidebar to jump to its page',
      ...
      'detail.galaxy': 'Galaxy: {name}',
      'detail.wanderer': 'Wandering star',
      'detail.connections': '🔗 Connected stars: {count} ({ai} wormholes)',
      'detail.index': '📇 Index: #{idx}',
      'tooltip.connections': '{count} connected nodes',
      'stats.loading': 'Loading...',
      'stats.empty': 'The knowledge universe is empty',
      'stats.count': '{n} nodes · {g} galaxies · {e} links',
      'breadcrumb.all': 'All',
      'breadcrumb.galaxy': '{name}',
      'breadcrumb.star': '{label}',
      'canvas.empty': 'No nodes in the knowledge universe yet. Go collect some knowledge points!',
      'zoom.in': 'Zoom in',
      'zoom.out': 'Zoom out',
