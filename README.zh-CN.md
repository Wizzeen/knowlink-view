...
> `ai-config.js` 已加入 `.gitignore`，**切勿**提交你的 API Key。
...
- **[Knowlink Page](https://github.com/Wizeeeee/knowlink-skill)** — 知识星系页面生成器（CLI + Skill）。把知识点 JSON 规范变成自包含的交互式 HTML 页面，与扩展共享同一套知识点数据模型与布局/渲染引擎。
